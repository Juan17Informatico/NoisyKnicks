...
<head>
  ...
  <link rel="icon" href="../img/ICN/traje.png">
    ...
    <div class="row">
      <div class="col-sm-4">
        <div class="card" style="width: 400px; margin: 22px">
          <img class="card-img-top" src="../img/Ropa/Ropa1.jpeg" alt="Card image" style="width: 100%" />
          <div class="card-body">
            <?php $var = "12345" ?>
      ...
      <div class="col-sm-4">
        <div class="card" style="width: 400px; margin: 22px">
          <img class="card-img-top" src="../img/Ropa/Ropa2.jpeg" alt="Card image" style="width: 100%" />
          <div class="card-body">
            <?php $var = "67891" ?>
      ...
      <div class="col-sm-4">
        <div class="card" style="width: 400px; margin: 22px">
          <img class="card-img-top" src="../img/Ropa/Ropa3.jpeg" alt="Card image" style="width: 100%" />
          <div class="card-body">
            <?php $var = "2314435" ?>
