    ...
    <main>
        <form action="login/index.php" method="POST">
            <div class="tarjeta d-flex justify-content-between" id="1">
                <a title="NoisyKnicks" href="login/index.php" class="m-auto p-0"><img src="../img/Página/Logo.jpeg" alt="NoisyKnicks" /></a>
                <a href="../index.php" class="m-0 p-0"><img src="../img/Página/cerrar-sesion.png" alt="NoisyKnicks"></a>
            </div>
        </form>
    </main>
